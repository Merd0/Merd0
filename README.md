...
**Algorithm Enthusiast | Full-Stack Perspective | System Architecture**

Yazılım geliştirme süreçlerine sadece kod yazmak olarak değil, **bir sistem mimarisi** olarak yaklaşıyorum. 
Veritabanı optimizasyonundan (SQL), yüksek seviyeli nesne yönelimli programlamaya (Java/C#), oradan da donanımın kalbine inen düşük seviyeli kontrollere (C/STM32) uzanan geniş bir yelpazede çalışıyorum.

Benim için önemli olan dil değil, **problemin nasıl çözüldüğüdür.**

---

### 🧠 Teknik Yetkinlikler (My Tech Stack)

**Yüksek Seviye & Uygulama Geliştirme:**
<p align="left">
...
<p align="left">
  <a href="https://linkedin.com/in/mert-aydın-0578a420b/" target="_blank">
    <img src="https://img.shields.io/badge/LinkedIn-Bağlantı_Kur-0077B5?style=for-the-badge&logo=linkedin" alt="LinkedIn"/>
  </a>
</p>

![Ziyaretçi Sayısı](https://visitcount.itsvg.in/api?id=Merd0&icon=5&color=9)
